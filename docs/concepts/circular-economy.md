...
updated: 2026-06-03
type: concept
tags: [adoption, business, merchant, circular-economy, local, community]
sources:
...
- [BTCMap](/entities/btcmap) — Merchant discovery map
- [Cashu](/entities/cashu) — Privacy-preserving ecash for payments
- [Strike](/entities/strike) — Consumer payment and acquisition app
- [Peer-to-Peer Exchange](/concepts/p2p-exchange) — Acquiring bitcoin without KYC
- [Chaumian eCash](/concepts/chaumian-ecash) — Privacy layer for merchant payments
- [Lightning Network](/concepts/lightning-network) — Payment rail for instant settlement

## Resources

- [BTCMap](https://btcmap.org)
- [Oshi](https://oshi.tech)
- [OpenNode](https://opennode.com)
- [IbexPay](https://ibexpay.io)
