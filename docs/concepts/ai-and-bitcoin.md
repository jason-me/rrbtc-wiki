...
updated: 2026-06-03
type: concept
tags: [AI, lightning, privacy, decentralization, LLM, sovereignty]
sources:
  - raw/why-lightning-plus-ai-2024-08-13.md
  - raw/cascdr-project-meetup-27-2024-08-08.md
  - raw/feed-filter-demo-2025-12-11.md
confidence: high
---
...
- [CASCDR](/entities/casdcr) — Lightning-native AI service platform
- [Feed Filter](/entities/feed-filter) — User-controlled AI social media filter
- [Lightning Network](/concepts/lightning-network) — Payment rail enabling AI micropayments
- [Nostr](/concepts/nostr) — Decentralized protocol used by AI tools for messaging

## Resources

- [CASCDR](https://cascdr.xyz)
- [Bitcoiner AI Discussions](https://austinbitcoindevelopers.com)
